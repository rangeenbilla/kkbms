...
class _$UserListRecord extends UserListRecord {
  ...
  factory _$UserListRecord([void Function(UserListRecordBuilder) updates]) =>
      (new UserListRecordBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UserListRecord')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'UserListRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
